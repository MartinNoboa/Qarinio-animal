    ...
    <!-- <table class="uk-table uk-table-divider uk-table-large uk-table-hover uk-animation-slide-bottom-medium">
        ...
        <tbody>
            <tr onclick="window.location='catalogo.php';">
                <td>1 (Hard Code)</td>
                <td class="uk-text-center"><a class="uk-link-text" href="#"><span class="uk-text-center uk-text-success" uk-icon="icon: check" uk-tooltip="title: ¡Tu formulario fue aprobado!"></a></span></td>
