...
<div class = "uk-container uk-margin-xlarge-left uk-margin-xlarge-right">
  <form method="post" action="crearCuenta.php" name='sign-up' id="sign-up">
    <h1 class="uk-text-center">Crear Cuenta</h1>
    <hr class="uk-divider-icon">
      ...
      switch($_SESSION["createState"]){
          case 0:
              echo "<button class='uk-button uk-button-primary uk-border-rounded uk-margin-bottom' value='Continuar' type='submit' name='submit' >Continuar</button>";
              break;
          case 1:
              echo "<button class='uk-button uk-button-default uk-border-rounded uk-margin-bottom uk-margin-right' value='Regresar' type='submit' name='submit' >Regresar</button>";
              echo "<button class='uk-button uk-button-primary uk-border-rounded uk-margin-bottom' type='submit' name='submit' value='Continuar'>Continuar</button>";
              break;
          case 2:
              echo "<button class='uk-button uk-button-default uk-border-rounded uk-margin-bottom uk-margin-right' value='Regresar' type='submit' name='submit' >Regresar</button>";
              echo "<button class='uk-button uk-button-primary uk-border-rounded uk-margin-bottom' type='submit' name='submit' id='terminar' value='Terminar' disabled = 'true'>Terminar</button>";
              break;
          default:
              break;
      }
